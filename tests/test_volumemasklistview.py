...
from emviz.views import ImageListView, VolumeMaskListView
from .test_commons import TestView


class TestVolumeMaskListView(TestView):
    __title = "VolumeMaskListView example"
