...
from emviz.widgets import PageBar, createQAction, createQPixmap
from emviz.models import PIXEL_UNITS
...
class VolumeView(QWidget):
    ...
    def __setupGUI(self, slicesKwargs, galleryKwargs):
        ...
        self._aSlices = createQAction(self._toolBar, 'Multi Slices View',
                                      'Multi Slices View', 'fa.sliders', True,
        ...
        self._aGallery = createQAction(self._toolBar, 'Gallery View',
        ...
        self._galleryView = GalleryView(self, **galleryKwargs)
