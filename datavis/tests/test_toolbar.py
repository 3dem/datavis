...
class TestToolBar(dv.tests.TestView):
    __title = "ToolBar example"
    ...
    def createView(self):
        ...
        toolBar = dv.widgets.ActionsToolBar(centralWidget,
        ...
        layout.addItem(qtw.QSpacerItem(20, 40, qtw.QSizePolicy.Minimum,
