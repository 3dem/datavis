...
class Observable:
    ...
    class Event:
        ...
        class. Event objects contain event parameters.
...
class PickerModel(TableModel, Observable):
    ...
    def addMicrograph(self, mic):
        ...
        self.notifyEvent(info=PickerModel.Result(micrographAdded=True,
                                                 micId=mic.getId()))
    ...
    def addCoordinates(self, micId, coords):
        ...
        # already added
        info = PickerModel.Result(micId=micId, coordsAdded=True,
                                  coords=coords,
                                  currentCoordsChanged=False,
                                  tableModelChanged=True)
        self.notifyEvent(info=info)
        return info
